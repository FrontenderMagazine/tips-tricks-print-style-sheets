...
* Рассмотреть печать как равноправную часть [адаптивного и отзывчивого веб-дизайна](http://uxdesign.smashingmagazine.com/2012/11/08/ux-design-qa-with-christian-holst/).
...
В то время, как использование `display: none` было по праву [раскритиковано в отзывчивом дизайне](http://laurakalbag.com/display-none/), 
...
*Страница с распечатанным QR-кодом, ведущим на веб-версию. [Увеличенное изображение](img/lizabeth_big.png).*
...
статье "[Тонирование веб-страниц с помощью SVG-фильтров и JavaScript](http://dev.opera.com/articles/view/applying-color-tints-to-web-pages-with-s/)"
на Dev.Opera.
...
* [CSS-дизайн: подготовка к печати](http://www.alistapart.com/articles/goingtoprint/), Eric Meyer (10 мая 2002)
* [Улучшение дизайна ссылок для печати](http://www.alistapart.com/articles/improvingprint/), Aaron Gustafson (19 сентября 2005)
* [Верстаем книги с помощью CSS3](http://www.alistapart.com/articles/building-books-with-css3/), Nellie McKesson (12 июня 2012)
* [Как настроить стили для печати](http://coding.smashingmagazine.com/2011/11/24/how-to-set-up-a-print-style-sheet/), Christian Krammer (24 ноября 2011)